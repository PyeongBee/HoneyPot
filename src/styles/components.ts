...
export function getToggleSwitchClasses(
  ...
  return cn(
    ...
    checked
      ? toggleSwitchStyles.states.checked
      : toggleSwitchStyles.states.unchecked,
    className
  );
}
...
export function getSidebarClasses(
  ...
  return cn(
    sidebarStyles.base,
    isCollapsed
      ? sidebarStyles.widths.collapsed
      : sidebarStyles.widths.expanded,
    className
  );
}
...
export function getDropdownClasses(
  ...
  return cn(
    ...
    align === "center"
      ? dropdownStyles.alignments.center
      : align === "right"
        ? dropdownStyles.alignments.right
        : isCollapsed !== undefined
          ? isCollapsed
            ? dropdownStyles.sidebarAlignments.collapsed
            : dropdownStyles.sidebarAlignments.expanded
...
export function getDropdownArrowClasses(
  ...
  return cn(
    ...
    position === "bottom"
      ? dropdownStyles.arrow.bottom
      : dropdownStyles.arrow.top,
...
export function getSidebarMenuItemClasses(
  ...
  return cn(
    ...
    isCollapsed
      ? sidebarMenuItemStyles.collapsed
      : sidebarMenuItemStyles.expanded,
    className
  );
}
...
export const sidebarMenuItemStyles = {
  ...
  label:
    "text-gray-700 dark:text-gray-300 ml-3 text-sm leading-5 truncate flex-1",
} as const;
