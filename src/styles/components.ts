...
export function getSidebarClasses(isCollapsed: boolean = false, className?: string) {
  return cn(
    sidebarStyles.base,
...
export function getSidebarMenuItemClasses(isCollapsed: boolean = false, className?: string) {
  return cn(
